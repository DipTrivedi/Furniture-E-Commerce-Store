        ...
        <div class="row justify-content-between">
            <div class="col-lg-5">
                <div class="intro-excerpt">
                    <h1>About Us</h1>
                    <p class="mb-4">At Classic Comfort, we create furniture that blends style, comfort, and durability.
                        Our mission is to transform houses into homes with designs that reflect modern living and
                        timeless elegance.
                    </p>
                    <p><a href="shop.php" class="btn btn-secondary me-2">Shop Now</a>
                    <a href="services.php" class="btn btn-white-outline">Service</a></p>
                </div>
            </div>
            <div class="col-lg-7">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                ...
                <h3 clas><a href="#"><span class="">Trivedi</span> Deep</a></h3>
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                ...
                <h3 clas><a href="#"><span class="">Prakhiya</span> Vandan</a></h3>
                <span class="d-block position mb-4">CEO, Founder, Atty.</span>
                <p>Separated they live in.
                    Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.
                </p>
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                ...
                <h3 clas><a href="#"><span class="">Mandani</span> Sagar</a></h3>
                <span class="d-block position mb-4">CEO, Founder, Atty.</span>
                <p>Separated they live in.
                    Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.
                </p>
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                ...
                <h3 clas><a href="#"><span class="">Der</span> Ravi</a></h3>
                <span class="d-block position mb-4">Helper</span>
                <p>Separated they live in.
                    Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.
                </p>
                <p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a>
